...
if __name__ == '__main__':
    ...
    outdir = make_outdir(source_name, name_bkg, len(energy_reco_bins),config_name, image_size,for_integral_flux,use_cube, use_etrue)
    ...
    if use_cube:
        ...
        if use_etrue:
            make_mean_rmf(energy_true,energy_reco,center,ObsList, outdir)
    else:
